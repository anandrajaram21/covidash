...
# def line_comparison(country, conf, death, rec):
#     whole_df = pd.DataFrame()
#     whole_df["dates"] = list(confirmed_global.columns[1:])
#     whole_df["confirmed"] = list(
#         conf.loc[confirmed_global["country"] == country].values.flatten()[
#             1:
#         ]
#     )
#     whole_df["deaths"] = list(
#         death.loc[deaths_global["country"] == country].values.flatten()[
#             1:]
#     )
#     whole_df["recovered"] = list(
#         rec.loc[recovered_global["country"] == country].values.flatten()[
#             1:
#         ]
#     )
