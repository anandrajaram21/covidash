...
confirmed_timeseries = timeseries.plot_world_timeseries(confirmed_global, "confirmed")
    ...
    if "confirmed-country" in changed_id:
        try:
            return (
                ...
                timeseries.static_line(confirmed_global, value),
            )
        except:
            return (
